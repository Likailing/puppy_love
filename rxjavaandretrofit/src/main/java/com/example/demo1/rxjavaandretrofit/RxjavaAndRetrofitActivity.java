package com.example.demo1.rxjavaandretrofit;

import android.os.Bundle;
import android.support.v7.app.AppCompatActivity;


import com.example.demo1.rxjavaandretrofit.movie.Movie;
import com.example.demo1.rxjavaandretrofit.movie.MovieLoader;
import com.example.demo1.rxjavaandretrofit.movie.MovieSubject;
import com.example.demo1.rxjavaandretrofit.util.ApiService;
import com.example.demo1.rxjavaandretrofit.util.DefaultDisposableObserver;
...
public class RxjavaAndRetrofitActivity extends AppCompatActivity {
    ...
    private void getData2(){
        ...
        apiService.getTop250Observable(0, 20)
                ...
                .map(new Function<MovieSubject, Object>() {
                    @Override
                    public Object apply(MovieSubject movieSubject) throws Exception {
                        return null;
                    }
                })
                .subscribe(new DefaultDisposableObserver<Object>() {
                    @Override
